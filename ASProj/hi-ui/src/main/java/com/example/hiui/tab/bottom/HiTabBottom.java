...
public class HiTabBottom extends RelativeLayout implements
        ...
        if (tabInfo.tabType == HiTabBottomInfo.TabType.ICON) {
            if (init) {
                ...
                Typeface typeface = Typeface.createFromAsset(
                        getContext().getAssets(), tabInfo.iconFont
                );
            ...
            if (selected) {
                tabIconView.setText(TextUtils.isEmpty(tabInfo.selectedIconName) ?
                        tabInfo.defaultIconName : tabInfo.selectedIconName);
